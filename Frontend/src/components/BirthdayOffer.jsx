...
export default function BirthdayOfferCard() {
  return (
    <div className="w-1/2 h-auto rounded-2xl shadow-2xl bg-gradient-to-r from-pink-500 to-purple-600 text-white p-10 flex flex-col justify-between items-center mx-auto mb-10 mt-2 relative overflow-hidden bg-cover bg-center"
      ...
      <div className="text-center">
        ...
        <p className="text-lg font-bold text-gray-900">Unwrap Sweet Deals Just for You!</p>
