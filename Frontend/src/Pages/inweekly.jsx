...
export default function InWeekly() {
  return (
    ...
    <InWeeklyprop image='./src/assets/pictures/momo.jpg' description='The best ever production of the weekly ad' totallb='3.4lb' perlb='$3/lb' price='$11.2' loggedIn={false}/>
